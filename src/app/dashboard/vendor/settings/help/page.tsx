      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-primary text-white">
          <CardContent className="p-8 space-y-4">
            ...
            <Button className="w-full bg-white text-primary hover:bg-white/90 rounded-xl">Start Live Chat</Button>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-8 space-y-4 flex flex-col justify-center h-full">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium">support@aquamart.com</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-primary" />
                <span className="text-sm font-medium">+1 (800) AQUA-HELP</span>
              </div>
            </div>
          </CardContent>
        </Card>
